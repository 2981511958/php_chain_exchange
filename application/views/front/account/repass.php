...
<html>
    <head>
        ...
        <title><?php echo lang('view_account_repass_1'); ?> - <?php echo $_SESSION['SYSCONFIG']['sysconfig_site_name']; ?></title>
    ...
    <body>
        ...
        <div class="account_box">
            <div class="page_title"><?php echo lang('view_account_repass_2'); ?> / <?php echo lang('view_account_repass_3'); ?></div>
            <div class="right_box">
                
                <div class="action_title">
                    <?php echo lang('view_account_repass_4'); ?>
                </div>

                <div class="action_box">
                    <div class="field_line_item">
                        <div class="input_ele_box">
                            <input class="input_ele" type="password" data-value="0" id="old_password" value="">
                            <label class="input_ele_label"><?php echo lang('view_account_repass_5'); ?></label>
                        </div>
                    </div>
                    <div class="field_line_item">
                        <div class="input_ele_box">
                            <input class="input_ele" type="password" data-value="0" id="new_password" value="">
                            <label class="input_ele_label"><?php echo lang('view_account_repass_6'); ?></label>
                        </div>
                    </div>
                    <div class="field_line_item">
                        <div class="input_ele_box">
                            <input class="input_ele" type="password" data-value="0" id="re_new_password" value="">
                            <label class="input_ele_label"><?php echo lang('view_account_repass_7'); ?></label>
                        </div>
                    </div>
                    ...
                    <div class="field_line_item">
                        <div class="input_ele_box phone_validate_box">
                            ...
                            <label class="input_ele_label"><?php echo lang('view_account_repass_8'); ?></label>
                        </div>
                    ...
                    <div class="field_line_item">
                        ...
                        <?php if($user['user_phone'] == ''){ ?>
                            <div class="input_ele_box phone_validate_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_repass_9'); ?></label>
                            </div>
                            <div class="send_btn send_validate_btn" attr-action="email">
                                <sapn class="btn_text"><?php echo lang('view_account_repass_10'); ?></sapn>
                                <i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop btn_load"></i>
                            </div>
                        <?php }else{ ?>
                            <div class="input_ele_box phone_validate_box">
                                <input class="input_ele" type="text" data-value="0" id="validate" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_repass_11'); ?></label>
                            </div>
                            <div class="send_btn send_validate_btn" attr-action="sms">
                                <sapn class="btn_text"><?php echo lang('view_account_repass_12'); ?></sapn>
                                <i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop btn_load"></i>
                            </div>
                        <?php } ?>
                    ...
                    <div class="field_line_item">
                        <div class="register_button repass_btn">
                            <span class="btn_text"><?php echo lang('view_account_repass_13'); ?></span>
                            <i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop btn_load"></i>
        ...
        <script type="text/javascript">
            ...
            $('.account_menu_item.repass').addClass('active');
                ...
                $('.send_validate_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#image_validate').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_repass_14'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                                ...
                                if (data.status) {
                                    ...
                                    var _setInterval = setInterval(function(){
                                        ...
                                        if (_validate_wait > 0) {
                                            ...
                                            _this.removeClass('off').find('.btn_text').text('<?php echo lang('view_account_repass_15'); ?>');
                                        }
                                    }, 1000);
                                }else{
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_repass_16'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
                ...
                $('.repass_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#old_password').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_repass_17'); ?>');
                            return false;
                        }

                        if($('#new_password').val() == ''){

                            _msg.error('<?php echo lang('view_account_repass_18'); ?>');
                            return false;
                        }

                        if($('#re_new_password').val() == ''){

                            _msg.error('<?php echo lang('view_account_repass_19'); ?>');
                            return false;
                        }

                        if($('#validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_repass_20'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_repass_21'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
