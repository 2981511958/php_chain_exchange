    ...
    <body>
        ...
        <div class="account_box">
            <div class="page_title">
                <?php echo lang('view_account_withdraw_2'); ?> / <?php echo lang('view_account_withdraw_3'); ?> / <?php echo lang('view_account_withdraw_4'); ?> <?php echo $coin['coin_symbol']; ?>    
                <a class="back_link" href="/account/asset"><< <?php echo lang('view_account_withdraw_5'); ?></a>
            </div>
            <div class="right_box">
