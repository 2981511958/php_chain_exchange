...
<html>
    ...
    <body>
        ...
        <style type="text/css">
            ...
            .account_box .right_box .action_box .field_line_item .input_ele_box .text_bar_box .text_content{ float: left; line-height: 40px; height: 40px; background: #697080; color: #FFF; width: 400px; text-align: center; font-size: 12px; }
        ...
        <div class="account_box">
            <div class="page_title"><?php echo lang('view_account_invite_2'); ?> / <?php echo lang('view_account_invite_3'); ?></div>
            <div class="right_box">
        ...
        <script type="text/javascript">
            ...
            $('.account_menu_item.invite').addClass('active');
