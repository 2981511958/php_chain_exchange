            ...
            <table class="layui-table" >
                ...
                <tbody>
                    ...
                    <tr style="position: relative;">
                        ...
                        <td><?php echo date('Y/m/d H:i:s', $orderItem['order_ftime']); ?></td>
                        <td>
                        ...
                        <td><?php echo $orderItem['order_price']; ?> <?php echo $orderItem['order_money_symbol']; ?></td>
                        <td><?php echo $orderItem['order_count']; ?> <?php echo $orderItem['order_stock_symbol']; ?></td>
                    </tr>
                    <?php }} ?>
                </tbody>
            </table>
