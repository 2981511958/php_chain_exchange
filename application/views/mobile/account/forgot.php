...
<html>
    ...
    <body>
        ...
        <div class="body_box">
            ...
            <header>
                <div class="market_list_btn"><?php echo lang('view_account_forgot_2'); ?></div>
                <div class="clear"></div>
            </header>

            <style type="text/css">
                
                .body_box .register_box{ margin: 50px auto; border-radius: 5px; background: #1f2126; padding: 0px 20px 40px 20px; }
