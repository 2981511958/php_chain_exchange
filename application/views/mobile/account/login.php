...
<html>
    <head>
        ...
        <title><?php echo lang('view_account_login_1'); ?> - <?php echo $_SESSION['SYSCONFIG']['sysconfig_site_name']; ?></title>
    ...
    <body>
        ...
        <div class="body_box">
            ...
            <header>
                <div class="market_list_btn"><?php echo lang('view_account_login_2'); ?></div>
                <div class="clear"></div>
            </header>
                    ...
                    <div class="register_type_box active" id="register_type_box_1">
                        ...
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_login_3'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="user_password" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_login_4'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box phone_validate_box">
                                <input class="input_ele" type="text" data-value="0" id="validate" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_login_5'); ?></label>
                            </div>
                        ...
                        <div class="field_line_item">
                            <div class="register_button login_btn">
                                <span class="btn_text"><?php echo lang('view_account_login_6'); ?></span>
                        ...
                        <div class="field_line_item">
                            <a class="link_btn left_link_btn" href="/account/forgot"><?php echo lang('view_account_login_7'); ?></a>
                            <a class="link_btn right_link_btn" href="/account/register"><?php echo lang('view_account_login_8'); ?></a>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                ...
                $('.login_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#user_name').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_login_9'); ?>');
                            return false;
                        }

                        if($('#user_password').val() == ''){

                            _msg.error('<?php echo lang('view_account_login_10'); ?>');
                            return false;
                        }

                        if($('#validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_login_11'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_login_12'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
