...
<html>
    ...
    <body>
        ...
        <header>
            <div class="market_list_btn"><?php echo lang('view_account_recharge_3'); ?> / <?php echo lang('view_account_recharge_4'); ?> <?php echo $coin['coin_symbol']; ?></div>
        ...
        <style type="text/css">
            ...
            .account_box .right_box .action_box .field_line_item .input_ele_box .text_bar_box .text_content{ line-height: 40px; height: 40px; background: #697080; color: #FFF; text-align: center; font-size: 12px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
            .account_box .right_box .action_box .field_line_item .input_ele_box .text_bar_box .text_btn{ background-color: #357ce1; line-height: 40px; height: 40px; color: #FFF; font-size: 16px; cursor: pointer; text-align: center; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
            ...
            .account_box .right_box .asset_list .item_line:hover{ background: rgba(53, 124, 225, 0.21); overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
            ...
            .account_box .get_wallet{ background-color: #357ce1; line-height: 50px; height: 50px; color: #FFF; font-size: 16px; cursor: pointer; text-align: center; border-radius: 5px; }
            ...
            .account_box .recharge_address_qrcode_box{ background: #FFF; padding: 20px; width: 200px; opacity: .8; margin: 0 auto; }
            ...
            .account_box .wallet_tab_box .wallet_tab_item_box .wallet_tab_item{ float: left; color: #3B97E9; font-size: 14px; line-height: 40px; text-align: center; cursor: pointer; width: 50%; border: #3B97E9 solid 1px; box-sizing: border-box; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
                ...
                <div class="action_box">
                    ...
                    <div>
                        <table class="asset_list" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr class="item_line">
                                <td class="hold"></td>
                                <td><?php echo date('m/d H:i:s', $recharge['recharge_time']); ?></td>
