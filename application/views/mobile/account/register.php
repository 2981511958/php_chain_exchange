...
<html>
    <head>
        ...
        <title><?php echo lang('view_account_register_1'); ?> - <?php echo $_SESSION['SYSCONFIG']['sysconfig_site_name']; ?></title>
    ...
    <body>
        ...
        <header>
            <div class="market_list_btn"><?php echo lang('view_account_register_2'); ?></div>
            <div class="clear"></div>
        </header>
        ...
        <div class="body_box">
            ...
            <style type="text/css">
                ...
                .body_box .register_box{ margin: 50px 20px; border-radius: 5px; background: #1f2126; }
                .body_box .register_box .box_title{ padding-bottom: 30px; }
                .body_box .register_box .box_title img{ display: block; width: 150px; margin: 0 auto; }
                .body_box .register_box .register_type_tab{ border-bottom: #3f4254 solid 2px; height: 50px; }
                .body_box .register_box .register_type_tab .tab_item{ float: left; font-size: 14px; color: #a7b7c7; line-height: 50px; text-align: center; cursor: pointer; transition: 0s; -moz-transition: 0s; -webkit-transition: 0s; -o-transition: 0s; width: 50%; }
                .body_box .register_box .register_type_tab .tab_item:hover{ color: #d5def2; }
                .body_box .register_box .register_type_tab .tab_item.active{ color: #d5def2; line-height: 50px; border-bottom: #357ce1 solid 2px; font-size: 16px; }
                ...
                .body_box .register_box .register_type_box .field_line_item .phone_validate_code{ display: block; float: right; width: calc((100% - 14px) / 2); border: #697080 solid 1px; border-radius: 5px; cursor: pointer; height: 53px; }
            ...
            <div class="register_box">
                <div class="box_title"><img class="logo_img" src="<?php echo $_SESSION['SYSCONFIG']['sysconfig_site_logo']; ?>"></div>
                <div class="register_type_tab">
                    <div class="tab_item" target-content="register_type_box_1"><?php echo lang('view_account_register_3'); ?></div>
                    <div class="tab_item active" target-content="register_type_box_2"><?php echo lang('view_account_register_4'); ?></div>
                    <div class="clear"></div>
                </div>

                <div>
                    <!-- 手机注册 -->
                    <div class="register_type_box" id="register_type_box_1">
                        <div class="field_line_item">
                            ...
                            <div class="input_ele_box phone_num_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_register_5'); ?></label>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box phone_validate_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_register_6'); ?></label>
                            </div>
                        ...
                        <div class="field_line_item">
                            <div class="input_ele_box phone_validate_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_register_7'); ?></label>
                            </div>
                            <div class="send_btn send_sms_btn">
                                <sapn class="btn_text"><?php echo lang('view_account_register_8'); ?></sapn>
                        ...
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_register_9'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="phone_repassword" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_10'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="phone_expassword" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_11'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="phone_reexpassword" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_12'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="text" data-value="0" id="phone_invite" value="<?php echo $inviteCode ? $inviteCode : ''; ?>" <?php echo $inviteCode ? 'readonly' : ''; ?>>
                                <label class="input_ele_label"><?php echo lang('view_account_register_13'); ?></label>
                            </div>
                        </div>
                        
                        <div class="field_line_item">
                            <div class="register_button phone_register_btn">
                                <span class="btn_text"><?php echo lang('view_account_register_14'); ?></span>
                                <i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop btn_load"></i>
                        ...
                        <div class="field_line_item">
                            <a class="link_btn left_link_btn" href="/account/forgot"><?php echo lang('view_account_register_15'); ?></a>
                            <a class="link_btn right_link_btn" href="/account/login"><?php echo lang('view_account_register_16'); ?></a>
                            <div class="clear"></div>
                        </div>
                    </div>

                    <!-- 邮箱注册 -->
                    <div class="register_type_box active" id="register_type_box_2">
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="text" data-value="0" id="user_email" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_17'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box phone_validate_box">
                                <input class="input_ele" type="text" data-value="0" id="email_image_validate" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_18'); ?></label>
                            </div>
                            <img src="/common/validate/195/54" onclick="javascript: this.src=(this.getAttribute('baseurl') + '?' + (new Date()).getTime());" baseurl="/common/validate/195/54" class="phone_validate_code">
                            <div class="clear"></div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box phone_validate_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_register_19'); ?></label>
                            </div>
                            <div class="send_btn send_email_btn">
                                <sapn class="btn_text"><?php echo lang('view_account_register_20'); ?></sapn>
                                <i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop btn_load"></i>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                ...
                                <label class="input_ele_label"><?php echo lang('view_account_register_21'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="email_repassword" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_22'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="email_expassword" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_23'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="password" data-value="0" id="email_reexpassword" value="">
                                <label class="input_ele_label"><?php echo lang('view_account_register_24'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="input_ele_box">
                                <input class="input_ele" type="text" data-value="0" id="email_invite" value="<?php echo $inviteCode ? $inviteCode : ''; ?>" <?php echo $inviteCode ? 'readonly' : ''; ?>>
                                <label class="input_ele_label"><?php echo lang('view_account_register_25'); ?></label>
                            </div>
                        </div>
                        <div class="field_line_item">
                            <div class="register_button email_register_btn">
                                <span class="btn_text"><?php echo lang('view_account_register_26'); ?></span>
                                <i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop btn_load"></i>
                                <i class="layui-icon layui-icon-ok btn_success"></i>
                            </div>
                        </div>
                        ...
                        <div class="field_line_item">
                            <a class="link_btn left_link_btn" href="/account/forgot"><?php echo lang('view_account_register_27'); ?></a>
                            <a class="link_btn right_link_btn" href="/account/login"><?php echo lang('view_account_register_28'); ?></a>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                ...
                $('.send_sms_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#user_phone').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_register_29'); ?>');
                            return false;
                        }

                        if($('#phone_image_validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_31'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                                ...
                                if (data.status) {
                                    ...
                                    var _setInterval = setInterval(function(){
                                        ...
                                        if (_validate_wait > 0) {
                                            ...
                                            _this.removeClass('off').find('.btn_text').text('<?php echo lang('view_account_register_32'); ?>');
                                        }
                                    }, 1000);
                                }else{
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_register_33'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
                ...
                $('.send_email_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#user_email').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_register_34'); ?>');
                            return false;
                        }

                        if($('#email_image_validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_35'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                                ...
                                if (data.status) {
                                    ...
                                    var _setInterval = setInterval(function(){
                                        ...
                                        if (_validate_wait > 0) {
                                            ...
                                            clearInterval(_setInterval);
                                            _this.removeClass('off').find('.btn_text').text('<?php echo lang('view_account_register_36'); ?>');
                                        }
                                    }, 1000);
                                }else{
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_register_37'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
                ...
                $('.phone_register_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#user_phone').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_register_38'); ?>');
                            return false;
                        }

                        if($('#phone_image_validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_39'); ?>');
                            return false;
                        }

                        if($('#phone_validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_40'); ?>');
                            return false;
                        }

                        if($('#phone_password').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_41'); ?>');
                            return false;
                        }

                        if($('#phone_repassword').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_42'); ?>');
                            return false;
                        }

                        if($('#phone_expassword').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_43'); ?>');
                            return false;
                        }

                        if($('#phone_reexpassword').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_44'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'reexpassword' : $('#phone_reexpassword').val(),
                                'invite_code' : $('#phone_invite').val()
                            },
                            dataType: 'json',
                            success: function (data) {
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_register_45'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
                ...
                $('.email_register_btn').click(function(){
                    ...
                    if (! _this.hasClass('off')) {
                        ...
                        if($('#user_email').val() == ''){
                            ...
                            _msg.error('<?php echo lang('view_account_register_46'); ?>');
                            return false;
                        }

                        if($('#email_image_validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_47'); ?>');
                            return false;
                        }

                        if($('#email_validate').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_48'); ?>');
                            return false;
                        }

                        if($('#email_password').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_49'); ?>');
                            return false;
                        }

                        if($('#email_repassword').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_51'); ?>');
                            return false;
                        }

                        if($('#email_expassword').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_52'); ?>');
                            return false;
                        }

                        if($('#email_reexpassword').val() == ''){

                            _msg.error('<?php echo lang('view_account_register_53'); ?>');
                            return false;
                        }
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'reexpassword' : $('#email_reexpassword').val(),
                                'invite_code' : $('#email_invite').val()
                            },
                            dataType: 'json',
                            success: function (data) {
                            ...
                            error: function(){
                                ...
                                _msg.error('<?php echo lang('view_account_register_54'); ?>');
                                _this.removeClass('off').find('.btn_text').show().siblings().hide();
                            }
                        });
                    }
