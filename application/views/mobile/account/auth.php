...
<html>
    ...
    <body>
        ...
        <header>
            <div class="market_list_btn"><?php echo lang('view_account_auth_3'); ?></div>
        ...
        <style type="text/css">
            ...
            .account_box .right_box .action_box .field_line_item .input_ele_box .image_input_item .image_input_bg{ position: absolute; left: 0px; top: 0px; width: 100%; height: 228px; z-index: 1; }
            .account_box .right_box .action_box .field_line_item .input_ele_box .image_input_item .preview_image{ position: absolute; left: 0px; top: 0px; width: 100%; height: 228px; z-index: 2; display: none; }
                    ...
                    <div class="field_line_item">
                        <div class="input_ele_box">
                            ...
                            <div class="image_input_item <?php echo ($user['user_auth'] == 1 || $user['user_auth'] == 3) ? 'off' : ''; ?>">
                                ...
                                <?php }else{ ?>
                                    <img src="/static/mobile/images/shenfen1.png" class="image_input_bg">
                    ...
                    <div class="field_line_item">
                        <div class="input_ele_box">
                            ...
                            <div class="image_input_item <?php echo ($user['user_auth'] == 1 || $user['user_auth'] == 3) ? 'off' : ''; ?>">
                                ...
                                <?php }else{ ?>
                                    <img src="/static/mobile/images/shenfen2.png" class="image_input_bg">
                                    <img src="" class="preview_image">
                                <?php } ?>
